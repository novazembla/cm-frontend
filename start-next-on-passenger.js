...
const commands = {
    build: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-build'));
        }).then((i)=>i.nextBuild
        )
    ,
    start: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-start'));
        }).then((i)=>i.nextStart
        )
    ,
    export: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-export'));
        }).then((i)=>i.nextExport
        )
    ,
    dev: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-dev'));
        }).then((i)=>i.nextDev
        )
    ,
    lint: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-lint'));
        }).then((i)=>i.nextLint
        )
    ,
    telemetry: ()=>Promise.resolve().then(function() {
            return _interopRequireWildcard(require('./node_modules/next/dist/cli/next-telemetry'));
...
if (command === 'dev') {
    const { CONFIG_FILE  } = require('./node_modules/next/shared/lib/constants');
