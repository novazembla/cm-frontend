    ...
    <Box layerStyle="blurredLightGray">
      <Box px="20px" pt="0.5em">
        ...
        <Box bg="#fff" borderRadius="lg" overflow="hidden">
          ...
          {!isEmptyHtml(getMultilangValue(tour.offers)) && (
            <Box
              className="item"
              px={{
                base: "20px",
            ...
            >
              ...
              >
                {t("tour.title.offers", "Offering the following")}:
              </Box>
              <Box textStyle="card">
                <MultiLangHtml json={tour.offers} />
              </Box>
            </Box>
          )}

          {!isEmptyHtml(getMultilangValue(tour.accessibilityInformation)) && (
            <Box
              className="item"
              px={{
                base: "20px",
            ...
            >
              ...
              >
                {t(
                  "tour.title.accessibilityInformation",
                  "Accessibility Information"
                )}
                :
              </Box>
              <Box textStyle="card">
                <MultiLangHtml json={tour.accessibilityInformation} />
              </Box>
            </Box>
          )}
            ...
            {!isEmptyHtml(tour.agency) && (
              <Box className="item">
                <Box
                  ...
                  textStyle="categories"
                >
                  {t("tour.label.agency", "Agency")}
                </Box>
                <Box textStyle="card">{tour.agency}</Box>
              </Box>
            )}
          </SimpleGrid>
        </Box>
